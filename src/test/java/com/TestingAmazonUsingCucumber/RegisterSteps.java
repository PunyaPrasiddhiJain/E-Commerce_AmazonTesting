...
public class RegisterSteps{
    ...
    public void iNavigateToAmazonRegistrationPage() {
    ...
    public void iFillTheRegistrationForm(String name, String mobile, String email, String password) {
...
//    	BaseCucumberClass.takeScreenshot("03_FillEmail");
    ...
    public void iShouldBeOnOtpVerificationPage() {
